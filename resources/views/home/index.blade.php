                ...
                <div class="footer-content pt-5 pb-5">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 mb-50">
                            <div class="footer-widget">
                                <div class="footer-logo">
                                    <a href="{{ url('index.html') }}"><img src="{{ url('assets2/img/BYTEMEX.png')}}" class="img-fluid" alt="logo"></a>
                                </div>
                                <div class="footer-text">
                                    <p class="descubre">¡Descubre los sabores auténticos de México en nuestro restaurante de comida mexicana! El sabor unico...</p>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                            <div class="footer-widget">
                                <div class="footer-widget-heading">
                                    <h3 class="enlace">Enlaces de Interés</h3>
                                </div>
                                <ul>
                                    <li><a class="afooter" href="#">Sobre nosotros</a></li>
                                    <li><a class="afooter" href="#">Aviso Legal</a></li>
                                    <li><a class="afooter" href="#">Menú</a></li>
                                    <li><a class="afooter" href="#">Política de Privacidad</a></li>
                                    <li><a class="afooter" href="#">Contáctanos</a></li>
                                    <li><a class="afooter" href="#">Política de Cookies</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
                            <div class="footer-widget">
                                <div class="footer-widget-heading">
                                    <h3 class="enlace">Nuestros Horarios</h3>
                                </div>
                                <div class="footer-text mb-25">
                                    <p class="enlace">Visítanos de lunes a viernes de 8:00 am a 9:00 pm y los Sábados de 9:00 am a 6:00 pm</p>
                                </div>
                            </div>
                        </div>
                    </div>
